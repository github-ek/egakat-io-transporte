...
import com.egakat.io.transporte.components.decorators.cumplidos.CamposPlanillaRutaControlDecorator;
import com.egakat.io.transporte.components.decorators.cumplidos.MapEntidadPlanillaRutaControlDecorator;
import com.egakat.io.transporte.domain.cumplidos.PlanillaRutaControl;
import com.egakat.io.transporte.repository.cumplidos.PlanillaRutaControlRepository;
import com.egakat.io.transporte.secundaria.service.api.cierres.PlanillaRutaControlInputService;

import lombok.val;

@Service
public class PlanillaRutaControlInputServiceImpl extends ArchivoExcelInputServiceImpl<PlanillaRutaControl> implements  PlanillaRutaControlInputService{
	...
	@Override
	protected Decorator<PlanillaRutaControl, Long> getIncluirEncabezadoDecorator(
			Decorator<PlanillaRutaControl, Long> inner) {
		return new IncluirEncabezadoDecorator<>(inner);
	}

	@Override
	protected Decorator<PlanillaRutaControl, Long> getEnriquecerCamposDecorator(
			Decorator<PlanillaRutaControl, Long> inner) {
